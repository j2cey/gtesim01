...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    SettingAddUpdate: function SettingAddUpdate() {
      return __webpack_require__.e(/*! import() */ 13).then(__webpack_require__.bind(null, /*! ./addupdate */ "./resources/js/views/settings/addupdate.vue"));
    },
    SettingItem: function SettingItem() {
      return __webpack_require__.e(/*! import() */ 14).then(__webpack_require__.bind(null, /*! ./item */ "./resources/js/views/settings/item.vue"));
    }
  },
  mounted: function mounted() {
    var _this = this;

    _settings_settingBus__WEBPACK_IMPORTED_MODULE_0__["default"].$on('setting_created', function (newsetting) {
      _this.settings.push(newsetting); //SettingBus.$emit('setting_created', newsetting)


      _this.$emit('setting_created', newsetting);
    });
  },
  data: function data() {
    return {
  ...
  methods: {
    createSetting: function createSetting() {
      _settings_settingBus__WEBPACK_IMPORTED_MODULE_0__["default"].$emit('setting_create');
    },
    deleteSetting: function deleteSetting($event) {
      console.log("setting_deleted received at list: ", $event);
      var settingIndex = this.settings.findIndex(function (c) {
    ...
    filteredSettings: function filteredSettings() {
      ...
      if (this.searchSettings !== '' && this.searchSettings) {
        tempSettings = tempSettings.filter(function (item) {
          return item.full_path.toUpperCase().includes(_this2.searchSettings.toUpperCase());
        });
      } // Sorting
