...
class UserLocalSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user4 = User::create([
            'name' => "Marion ATOME",'username' => "matome",'email' => "M.ATOMENZE@gabontelecom.ga",'password' => bcrypt('marion123'), 'status_id' => Status::active()->first()->id
        ]);
        $user4->assignRole([$editorrole->id]);
    }
}
