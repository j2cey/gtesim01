            ...
            <div class="tw-bg-white tw-shadow-md tw-rounded tw-px-3 md:tw-px-8 tw-pt-3 md:tw-pt-6 tw-pb-3 md:tw-pb-8 tw-mb-4">
                ...
                <div class="tw-mb-4">
                    ...
                    <h2 class="tw-text-blue-600 tw-text-sm tw-font-bold tw-mb-3 tw-border-b tw-border-gray-400 tw-pb-2">
                        <span class="text text-align-left">Liste des Utilisateurs</span>
                        <span class="text text-align-right">
                            @can('user-create')
                            <b-button size="is-small" type="is-info is-light" @click="$emit('create_new_user', -1)"><i class="fas fa-plus"></i></b-button>
                            @endcan
                        </span>
                    </h2>
                    ...
                    <search-results group="user-search" v-slot="{ total, records }">
                            ...
                            <template v-if="records.length">
                                ...
                                <table class="table-auto">
                                    ...
                                    <tr>
                                        ...
                                        <th class="tw-px-4 tw-py-2">Username</th>
                                        <th class="tw-px-4 tw-py-2">Email</th>
                                        <th class="tw-px-4 tw-py-2">Employe</th>
                                        <th class="tw-px-4 tw-py-2">Connexion Types</th>
                                    ...
                                    >
                                        ...
                                        <td class="tw-px-4 tw-py-2">
                                            <span class="tw-text-sm">@{{ record.name }}</span>
                                        </td>
                                        <td class="tw-px-4 tw-py-2">
                                            <span class="tw-text-sm">@{{ record.username }}</span>
                                        </td>
                                        <td class="tw-px-4 tw-py-2">
                                        ...
                                        <td class="tw-px-6 tw-py-2">
                                            <span class="tw-text-sm" v-if="record.employe">
                                              <dl>
                                                <dt><span class="tw-text-xs"> <b> Nom: </b> </span></dt>
                                                <dd><span class="tw-text-xs"> @{{ record.employe.nom_complet }} </span></dd>
                                                <dt><span class="tw-text-xs"> <b> Matricule: </b> </span></dt>
                                                <dd><span class="tw-text-xs"> @{{ record.employe.matricule }} </span></dd>
                                                <dt><span class="tw-text-xs"> <b> Fonction: </b> </span></dt>
                                                <dd><span class="tw-text-xs" v-if="record.employe.fonction"> @{{ record.employe.fonction.intitule }} </span></dd>
                                                <dt><span class="tw-text-xs"> <b> Departement: </b> </span></dt>
                                                <dd><span class="tw-text-xs" v-if="record.employe.departement"> @{{ record.employe.departement.intitule }} </span></dd>
                                              </dl>
                                            </span>
                                        </td>
                                        <td class="tw-px-4 tw-py-2">
                                          <span class="tw-text-sm">
                                            <dl>
                                              <dd>
                                                <span v-if="record.is_local" class="tw-text-xs tw-font-semibold tw-inline-block tw-py-1 tw-px-2 tw-rounded tw-text-green-600 tw-bg-green-200 tw-w-32 last:tw-mr-0 tw-mr-1">local</span>
                                              </dd>
                                              <dd>
                                                <span v-if="record.is_ldap" class="tw-text-xs tw-font-semibold tw-inline-block tw-py-1 tw-px-2 tw-rounded tw-text-blue-600 tw-bg-blue-200 tw-w-32 last:tw-mr-0 tw-mr-1">ldap</span>
                                              </dd>
                                            </dl>
                                          </span>
                                        </td>
                                        ...
                                        <td class="tw-px-4 tw-py-2">
                                            @can('user-edit')
                                            <a @click="$emit('edit_user', record)" class="tw-inline-block tw-mr-3 tw-text-green-500">
                    ...
                    <search-pagination group="user-search" :always-show="true"></search-pagination>
