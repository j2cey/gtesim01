                ...
                <div class="tw-mb-4">
                    ...
                    <h5 class="tw-text-blue-600 tw-text-sm tw-font-bold tw-mb-3 tw-border-b tw-border-gray-400 tw-pb-2">
                        ...
                        <span class="text text-align-right">
                            @can('howtothread-create')
                                <b-button size="is-small" type="is-info is-light" @click="$emit('create_new_howtothread', -1)"><i class="fas fa-plus"></i></b-button>
                            @endcan
                        </span>
                    </h5>
                    ...
                    <search-form
                        group="howtothread-search"
                        url="{{ route('howtothreads.fetch') }}"
                        :params="{
                            search: '',
                    ...
                    <search-results group="howtothread-search" v-slot="{ total, records }">
                                                ...
                                                <h5 class="tw-text-sm tw-mb-2 tw-cursor-pointer">
                                                    ...
                                                    <span class="tw-text-xs tw-text-teal-800 tw-font-mono tw-bg-teal-100 tw-inline tw-rounded-full tw-px-2 align-top float-right tw-animate-pulse">
                                                        @can('howtothread-edit')
                                                            ...
                                                            <i class="fa fa-pencil-square-o" @click="$emit('edit_howtothread', record)"></i>
                                                        </span>
                                                        @endcan
                                                        @can('howtothread-edit')
                                                            <a :href="record.show_url" class="tw-inline-block tw-mr-3 tw-text-red-500">
                    ...
                    <search-pagination group="howtothread-search" :always-show="true"></search-pagination>
