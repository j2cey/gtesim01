				...
				<div class="receipt-main col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
						...
						<table class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td class="col-md-8">{{ $phonenum->hasphonenum->latestEmailAddress->email }}</td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									...
									<td class="col-md-8">{{ $phonenum->numero }}</td>
								</tr>
								<tr>
					...
					<div class="row">
						<div class="col-md-4 text-left">
							<a href="{{ route('clientesims.show', $phonenum->hasphonenum->uuid) }}" class="btn btn-sm btn-secondary text-left">Retour</a>
						</div>
