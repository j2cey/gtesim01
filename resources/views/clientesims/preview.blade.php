                ...
                <div class="row">
                    <div class="col-xs-3 col-sm-3 col-md-8 text-left">
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-4 text-right">
                            <div class="receipt-right">
                                <img class="img-responsive" alt="logo" src="{{url('images/logo.png')}}" style="width: 81px; border-radius: 4px;">
                            </div>
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="row">
                        <div class="col text-center">
                            <p>Scannez ce QR code pour telecharger votre profile E-SIM</p>
                            <p>{{ $acqrcode }}</p>
					...
					<div class="row">
						<div class="col-md-6">
							<a href="{{ route('clientesims.index') }}" class="btn btn-sm btn-secondary text-left">Clients</a>
						</div>
