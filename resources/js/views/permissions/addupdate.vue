        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" @click="updatePermission()" :disabled="!isValidForm" v-if="editing">Enregistrer</button>
                    <button type="button" class="btn btn-primary btn-sm" @click="createPermission()" :disabled="!isValidForm" v-else>Créer Permission</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
