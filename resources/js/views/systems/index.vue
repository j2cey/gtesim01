<template>
    <div class="container-fluid">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ settings.length }}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
        ...
        <div class="row">
            <div class="col-md-12">
                <SettingList list_title_prop="Settings List" :settings_prop="settings" :settings_grouped_prop="settings_grouped" v-on:setting_created="addSetting"></SettingList>
            </div>
            <!-- /.col -->
        </div>
        <!-- /.row -->
