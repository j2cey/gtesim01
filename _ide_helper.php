...
')
     ...
     */ 
         ...
         * @param string $name
         * @param \Adldap\Connections\ConnectionInterface $connection
     ...
     */ 
        ...
        {
                        return \Illuminate\Database\Schema\Blueprint::baseFields();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function dropBaseForeigns()
        {
                        return \Illuminate\Database\Schema\Blueprint::dropBaseForeigns();
        }
